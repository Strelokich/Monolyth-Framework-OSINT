...
MODULES = [
    ...
    ("04", "MDWE MODULE",        "mdwe.py",           "Metadata & web entity extraction"),
    ("05", "PHONE LOOKUP",       "phone_number.py",   "Carrier, region, social footprint"),
    ("06", "USERNAME HUNT",      "Username.py",       "Cross-platform username discovery"),
    ("07", "SEARCH_ENGINE",      "Search_engine.py",  "Universal search engine for osint"),
    ("08", "Interactive Board beta",   "InterActiveBoard.py",   " Ineractive board for Investigation")
]
